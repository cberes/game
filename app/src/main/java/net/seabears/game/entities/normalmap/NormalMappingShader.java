...
public class NormalMappingShader extends ShaderProgram {
    ...
    public void loadLights(final List<Light> lights, Camera camera) {
      ...
      range(0, this.lights).forEach(i -> loadLight(i < lights.size() ? lights.get(i) : OFF_LIGHT, i, viewMatrix));
    }
    ...
    private void loadLight(Light light, int index, Matrix4f viewMatrix) {
      ...
      super.loadFloat(locationLightPosition[index], getEyeSpacePosition(light.getPosition(), viewMatrix));
    }
