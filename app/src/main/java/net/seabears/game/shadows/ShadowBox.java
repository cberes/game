...
public class ShadowBox {
     ...
     *        point from world space into "light" space (i.e. changes a point's coordinates from
     *        being in relation to the world's axis to being in terms of the light's local axis).
     ...
     * frustum, to make sure that the box covers the smallest area possible while still ensuring
     * that everything inside the camera's view (within a certain range) will cast shadows.
     */
